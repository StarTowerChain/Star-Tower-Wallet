...
import 'package:hd_wallet_plugin/bitcoin/index.dart';
...
class BtcService extends BaseService {
  ...
  init(String apiUri, String rpc, [String? apiKey]) {
    wallet = BitcoinWallet(rpcUrl: rpc, apiUrl: apiUri, apiKey: apiKey ?? '');
  }
  ...
  Future<HdWallet> generateHDWallet() {
    String _mnemonic = ChainService.generateMnemonic();
    return wallet.deriveChildWallet(mnemonic: _mnemonic);
  }
